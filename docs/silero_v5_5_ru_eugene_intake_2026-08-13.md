...
full technical acoustic gate, immutable contract and exactly one detector-inference run. The result
does not change this route's personal-research, exact-route-only scope.

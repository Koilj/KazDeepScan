...
Для каждого фактического числа верных классификаций добавлен двухсторонний 95% Wilson
interval. Он описывает только конечный размер данного test set, а не переносимость между
corpus, выбор seed или uncertainty подготовки данных. У balanced accuracy нет одного
binomial denominator, поэтому interval не выдумывается.

| Seed | Верно / всего | Accuracy, 95% CI | bona-fide recall, 95% CI | spoof recall, 95% CI |
| ---: | ---: | ---: | ---: | ---: |
| 20260810 | 142 / 192 | 0.7396 [0.6732, 0.7965] | 0.4681 [0.3705, 0.5682] | 1.0000 [0.9623, 1.0000] |
| 20260811 | 163 / 192 | 0.8490 [0.7915, 0.8927] | 0.7021 [0.6032, 0.7852] | 0.9898 [0.9444, 0.9982] |
| 20260812 | 165 / 192 | 0.8594 [0.8031, 0.9015] | 0.7872 [0.6941, 0.8578] | 0.9286 [0.8598, 0.9650] |

В частности, perfect spoof recall первого запуска не означает отсутствие ошибки: при 98
spoof clips его нижняя 95% граница равна 0.9623. Эти intervals дополняют, но не сглаживают
намного более крупный меж-seed разброс balanced accuracy.

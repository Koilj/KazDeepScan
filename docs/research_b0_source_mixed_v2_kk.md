...
казахский spoof source или создать 3–5 новых generator family с отдельным OOD. LRLspoof
**исключён**: официальная публикация — единый примерно 452 GB sequential gzip/tar archive,
который нельзя скачать выборочно по папке Kazakh, и содержит только spoof class. Он не входит
в ledger, не смешивается с KSC и не является следующим кандидатом; обоснование сохранено в
[audit](data_sources_lrlspoof_2026-08-10.md).

...
> source intake и official VoxCPM2 artifact/source/history gate уже завершены; следующий gate —
> isolated runtime/dependency lock и один non-candidate text-only CUDA smoke.

"""Publish only complete reviewed-pair candidates from exact salvaged audio evidence."""
...
from kds.data.v4_final_reconciliation import (
    V4FinalReconciliationError,
    finalize_pair_lock,
...
def main() -> int:
    ...
    except (OSError, RuntimeError, ValueError, V4FinalReconciliationError) as error:
